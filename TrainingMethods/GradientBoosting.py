...
def GradientBoosting(train_data, test_data, predict_data, feature_num, model):
    clf = GradientBoostingClassifier(n_estimators=50, learning_rate=0.1, max_depth=12, random_state=0)
    print "GradientBoosting TrainingMethods..."
    if model == 1:
